...
set CLASSPATH=%APP_HOME%\lib\Lab3-1.0-SNAPSHOT.jar;%APP_HOME%\lib\log4j-core-2.24.3.jar;%APP_HOME%\lib\log4j-api-2.24.3.jar;%APP_HOME%\lib\sqlite-jdbc-3.49.1.0.jar


@rem Execute Lab3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB3_OPTS%  -classpath "%CLASSPATH%" ro.mpp2025.MainBD %*
